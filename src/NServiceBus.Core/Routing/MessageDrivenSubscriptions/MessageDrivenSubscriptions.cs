namespace NServiceBus.Features
{
    ...
    public class MessageDrivenSubscriptions : Feature
    {
        ...
        {
            EnableByDefault();
            Prerequisite(c => c.Settings.Get<TransportDefinition>().Infrastructure.OutboundRoutingPolicy.Publishes == OutboundRoutingType.Unicast, "The transport supports native pub sub");
        }
